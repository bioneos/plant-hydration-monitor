...
const char SSID[] =  "CenturyLink5084"; // Your current WiFi network SSID (can be hidden)
const char PASS[] =  "c6d7b4r76dfafb"; // Your current WiFi network password
const char *SERVER = "192.168.0.138"; // Your IP address on the WiFi network
